...
const RecentActivities = () => {
    const activitesData = jsonData.data;
    ...
    <View style={styles.activitiesContainer}>
       {activitesData.map((item) => (
        <View key={item.name} style={styles.activityCard}>
            ...
            <Image style={styles.activityCard.profilePic} source={require('../../assets/1.jpeg')}/>
           <View>
           <Text >{item.name}</Text>
           ...
           <Image  style={styles.activityCard.nextButton} source={require('../../assets/icons/next.png')}></Image>
            </View>
